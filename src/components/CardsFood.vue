...
<template>
    ...
    <navigate></navigate>
    <div style="margin-left:10%;">所有美食-共有{{DataStore.FoodsLength}}筆資料</div>
    <section>
        <div class="card" v-for="(item,key) in DataStore.Foodsdata" :key="item.index"
    ...
    <div class="modalBox" v-if="active" >
        ...
        <div class="IntroA">
                <img :src="tempObj.Picture1" v-if="tempObj.Picture1" class="imgIncard">
                <img src="../assets/img/unsplash_L6xHmv2R3G4@2x.png" v-else class="imgIncard">
            <div>
        ...
        <div class="IntroB">
            <h4 class="title fBold f28">美食介紹</h4>
...
div.pictureArea{
    ...
    background-image:url('https://swcoast-nsa.travel/image/2390/640x480');
